...
class AuthenticationApi extends BaseApi
{
     ...
     * @return \Walmart\Models\MP\CL\Authentication\TokenDetailResponse
     */
    public function getTokenDetail(): \Walmart\Models\MP\CL\Authentication\TokenDetailResponse
    {
     ...
     * @return \Walmart\Models\MP\CL\Authentication\TokenDetailResponse
     */
    protected function getTokenDetailWithHttpInfo(): \Walmart\Models\MP\CL\Authentication\TokenDetailResponse
    {
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\Walmart\Models\MP\CL\Authentication\TokenDetailResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Walmart\Models\MP\CL\Authentication\TokenDetailResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return ObjectSerializer::deserialize($content, '\Walmart\Models\MP\CL\Authentication\TokenDetailResponse', $response->getHeaders());
            }

            $returnType = '\Walmart\Models\MP\CL\Authentication\TokenDetailResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Walmart\Models\MP\CL\Authentication\TokenDetailResponse',
     ...
     * @throws \Walmart\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Walmart\Models\MP\CL\Authentication\OAuthToken
     */
    ...
    ): \Walmart\Models\MP\CL\Authentication\OAuthToken {
    ...
    protected function tokenAPIWithHttpInfo(
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\Walmart\Models\MP\CL\Authentication\OAuthToken' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Walmart\Models\MP\CL\Authentication\OAuthToken' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return ObjectSerializer::deserialize($content, '\Walmart\Models\MP\CL\Authentication\OAuthToken', $response->getHeaders());
            }

            $returnType = '\Walmart\Models\MP\CL\Authentication\OAuthToken';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
