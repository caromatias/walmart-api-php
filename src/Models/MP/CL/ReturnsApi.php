...
class ReturnsApi extends BaseApi
{
     ...
     * @return \Walmart\Models\MP\CL\Returns\GetReturnOrdersResponseWithCursor|\Walmart\Models\MP\CL\Returns\ErrorResponse|\Walmart\Models\MP\CL\Returns\ErrorResponse
     */
    ...
    ): \Walmart\Models\MP\CL\Returns\GetReturnOrdersResponseWithCursor {
    ...
    protected function getAllReturnsUsingCursorWithHttpInfo(
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\Walmart\Models\MP\CL\Returns\GetReturnOrdersResponseWithCursor' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Walmart\Models\MP\CL\Returns\GetReturnOrdersResponseWithCursor' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return ObjectSerializer::deserialize($content, '\Walmart\Models\MP\CL\Returns\GetReturnOrdersResponseWithCursor', $response->getHeaders());
                case 400:
                    if ('\Walmart\Models\MP\CL\Returns\ErrorResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Walmart\Models\MP\CL\Returns\ErrorResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return ObjectSerializer::deserialize($content, '\Walmart\Models\MP\CL\Returns\ErrorResponse', $response->getHeaders());
                case 500:
                    if ('\Walmart\Models\MP\CL\Returns\ErrorResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
            ...
            $returnType = '\Walmart\Models\MP\CL\Returns\GetReturnOrdersResponseWithCursor';
            ...
            switch ($e->getCode()) {
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Walmart\Models\MP\CL\Returns\ErrorResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Walmart\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Walmart\Models\MP\CL\Returns\GetReturnOrdersResponse|\Walmart\Models\MP\CL\Returns\ErrorResponse|\Walmart\Models\MP\CL\Returns\ErrorResponse
     */
    public function getReturns(
        ...
        ?string $statusCodeFilter = null,
        ?string $isWFSEnabled = null
    ): \Walmart\Models\MP\CL\Returns\GetReturnOrdersResponse {
    ...
    protected function getReturnsWithHttpInfo(
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\Walmart\Models\MP\CL\Returns\GetReturnOrdersResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Walmart\Models\MP\CL\Returns\GetReturnOrdersResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return ObjectSerializer::deserialize($content, '\Walmart\Models\MP\CL\Returns\GetReturnOrdersResponse', $response->getHeaders());
                case 400:
                    if ('\Walmart\Models\MP\CL\Returns\ErrorResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
            ...
            $returnType = '\Walmart\Models\MP\CL\Returns\GetReturnOrdersResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     * @param  \Walmart\Models\MP\CL\Returns\OrderRefundRequest $orderRefundRequest OrderRefund request body (required)
     *
     * @throws \Walmart\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return string|\Walmart\Models\MP\CL\Returns\ErrorResponse|\Walmart\Models\MP\CL\Returns\ErrorResponse
     */
    public function refundOrderLines(
        string $returnOrderId,
        \Walmart\Models\MP\CL\Returns\OrderRefundRequest $orderRefundRequest
    ): string {
