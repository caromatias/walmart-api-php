...
class ReturnOrderLine extends BaseModel
{
    ...
    protected static array $openAPITypes = [
        ...
        'item' => '\Walmart\Models\MP\CL\Returns\Item',
        'charges' => '\Walmart\Models\MP\CL\Returns\Charge[]',
        'unitPrice' => '\Walmart\Models\MP\CL\Returns\RefundAmount',
        'chargeTotals' => '\Walmart\Models\MP\CL\Returns\ChargeTotal[]',
        'quantity' => '\Walmart\Models\MP\CL\Returns\QuantityType',
        'status' => 'string',
        'statusTime' => 'string',
        'refundAmount' => '\Walmart\Models\MP\CL\Returns\RefundAmount',
     ...
     * Gets item
     *
     * @return \Walmart\Models\MP\CL\Returns\Item|null
     ...
     * Sets item
     *
     * @param \Walmart\Models\MP\CL\Returns\Item|null $item item
     *
     * @return self
     ...
     * Gets charges
     *
     * @return \Walmart\Models\MP\CL\Returns\Charge[]|null
     ...
     * Sets charges
     *
     * @param \Walmart\Models\MP\CL\Returns\Charge[]|null $charges Information relating to the charge for the orderLine
     *
     * @return self
     ...
     * Gets unitPrice
     *
     * @return \Walmart\Models\MP\CL\Returns\RefundAmount|null
     ...
     * Sets unitPrice
     *
     * @param \Walmart\Models\MP\CL\Returns\RefundAmount|null $unitPrice unitPrice
     *
     * @return self
     ...
     * Gets chargeTotals
     *
     * @return \Walmart\Models\MP\CL\Returns\ChargeTotal[]|null
     ...
     * Sets chargeTotals
     *
     * @param \Walmart\Models\MP\CL\Returns\ChargeTotal[]|null $chargeTotals Contains name value pairs of calculated charges for the line. Eg: if order line has 3 Qty, this will have a shipping charge = 3 * shipping charge per unit (This is present in the line level charges).
     *
     * @return self
     ...
     * Sets refundAmount
     *
     * @param \Walmart\Models\MP\CL\Returns\RefundAmount|null $refundAmount refundAmount
     *
     * @return self
