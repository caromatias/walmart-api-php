...
class FeedsApi extends BaseApi
{
     ...
     * @return \Walmart\Models\MP\CL\Feeds\FeedRecordResponse
     */
    public function getAllFeedStatuses(
        ?string $feedId = null,
        ?string $offset = '0',
        ?string $limit = '50'
    ): \Walmart\Models\MP\CL\Feeds\FeedRecordResponse {
    ...
    protected function getAllFeedStatusesWithHttpInfo(
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\Walmart\Models\MP\CL\Feeds\FeedRecordResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Walmart\Models\MP\CL\Feeds\FeedRecordResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return ObjectSerializer::deserialize($content, '\Walmart\Models\MP\CL\Feeds\FeedRecordResponse', $response->getHeaders());
            }

            $returnType = '\Walmart\Models\MP\CL\Feeds\FeedRecordResponse';
     ...
     * @throws \Walmart\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Walmart\Models\MP\CL\Feeds\PartnerFeedResponse
     */
    public function getFeedItemStatus(
        ...
        ?string $offset = '0',
        ?string $limit = '50'
    ): \Walmart\Models\MP\CL\Feeds\PartnerFeedResponse {
    ...
    protected function getFeedItemStatusWithHttpInfo(
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\Walmart\Models\MP\CL\Feeds\PartnerFeedResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Walmart\Models\MP\CL\Feeds\PartnerFeedResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return ObjectSerializer::deserialize($content, '\Walmart\Models\MP\CL\Feeds\PartnerFeedResponse', $response->getHeaders());
            }

            $returnType = '\Walmart\Models\MP\CL\Feeds\PartnerFeedResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
