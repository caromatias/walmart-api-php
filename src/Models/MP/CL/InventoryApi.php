...
class InventoryApi extends BaseApi
{
     ...
     * @return \Walmart\Models\MP\CL\Inventory\Inventory
     */
    public function getInventory(
        string $sku
    ): \Walmart\Models\MP\CL\Inventory\Inventory {
    ...
    protected function getInventoryWithHttpInfo(
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\Walmart\Models\MP\CL\Inventory\Inventory' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Walmart\Models\MP\CL\Inventory\Inventory' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return ObjectSerializer::deserialize($content, '\Walmart\Models\MP\CL\Inventory\Inventory', $response->getHeaders());
            }

            $returnType = '\Walmart\Models\MP\CL\Inventory\Inventory';
     ...
     * @throws \Walmart\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Walmart\Models\MP\CL\Inventory\FeedId
     */
    public function updateBulkInventory(
        string $feedType,
        \SplFileObject $file
    ): \Walmart\Models\MP\CL\Inventory\FeedId {
    ...
    protected function updateBulkInventoryWithHttpInfo(
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\Walmart\Models\MP\CL\Inventory\FeedId' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Walmart\Models\MP\CL\Inventory\FeedId' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return ObjectSerializer::deserialize($content, '\Walmart\Models\MP\CL\Inventory\FeedId', $response->getHeaders());
            }

            $returnType = '\Walmart\Models\MP\CL\Inventory\FeedId';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     * @param  \Walmart\Models\MP\CL\Inventory\Inventory $inventory File fields (required)
     *
     * @throws \Walmart\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Walmart\Models\MP\CL\Inventory\Inventory
    ...
    public function updateInventoryForAnItem(
        string $sku,
        \Walmart\Models\MP\CL\Inventory\Inventory $inventory
    ): \Walmart\Models\MP\CL\Inventory\Inventory {
