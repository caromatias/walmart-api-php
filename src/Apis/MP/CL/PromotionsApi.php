...
class PromotionsApi extends BaseApi
{
     ...
     * @return \Walmart\Models\MP\CL\Promotions\PromotionalPriceResponse
     */
    public function getPromotionalPrices(
        string $sku
    ): \Walmart\Models\MP\CL\Promotions\PromotionalPriceResponse {
    ...
    protected function getPromotionalPricesWithHttpInfo(
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\Walmart\Models\MP\CL\Promotions\PromotionalPriceResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Walmart\Models\MP\CL\Promotions\PromotionalPriceResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return ObjectSerializer::deserialize($content, '\Walmart\Models\MP\CL\Promotions\PromotionalPriceResponse', $response->getHeaders());
            }

            $returnType = '\Walmart\Models\MP\CL\Promotions\PromotionalPriceResponse';
     ...
     * @throws \Walmart\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Walmart\Models\MP\CL\Promotions\FeedId
     */
    public function updateBulkPromotionalPrice(
        string $feedType,
        \SplFileObject $file
    ): \Walmart\Models\MP\CL\Promotions\FeedId {
    ...
    protected function updateBulkPromotionalPriceWithHttpInfo(
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\Walmart\Models\MP\CL\Promotions\FeedId' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Walmart\Models\MP\CL\Promotions\FeedId' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return ObjectSerializer::deserialize($content, '\Walmart\Models\MP\CL\Promotions\FeedId', $response->getHeaders());
            }

            $returnType = '\Walmart\Models\MP\CL\Promotions\FeedId';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     * @param  \Walmart\Models\MP\CL\Promotions\Price $price The request body consists of a Feed file attached to the request. (required)
     *
     * @throws \Walmart\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Walmart\Models\MP\CL\Promotions\ItemPriceResponse
     */
    public function updatePromotionalPrices(
        bool $promo,
        \Walmart\Models\MP\CL\Promotions\Price $price
    ): \Walmart\Models\MP\CL\Promotions\ItemPriceResponse {
    ...
    protected function updatePromotionalPricesWithHttpInfo(
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\Walmart\Models\MP\CL\Promotions\ItemPriceResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Walmart\Models\MP\CL\Promotions\ItemPriceResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return ObjectSerializer::deserialize($content, '\Walmart\Models\MP\CL\Promotions\ItemPriceResponse', $response->getHeaders());
            }

            $returnType = '\Walmart\Models\MP\CL\Promotions\ItemPriceResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
