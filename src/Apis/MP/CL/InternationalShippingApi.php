...
class InternationalShippingApi extends BaseApi
{
     ...
     * Create label
     *
     * @param  \Walmart\Models\MP\CL\InternationalShipping\LabelGenerationRequestMx $labelGenerationRequestMx Label fields (required)
     *
     * @throws \Walmart\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Walmart\Models\MP\CL\InternationalShipping\CommonResponseLabelGenerationResponseMx
     */
    public function createLabel(
        \Walmart\Models\MP\CL\InternationalShipping\LabelGenerationRequestMx $labelGenerationRequestMx
    ): \Walmart\Models\MP\CL\InternationalShipping\CommonResponseLabelGenerationResponseMx {
    ...
    protected function createLabelWithHttpInfo(
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\Walmart\Models\MP\CL\InternationalShipping\CommonResponseLabelGenerationResponseMx' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Walmart\Models\MP\CL\InternationalShipping\CommonResponseLabelGenerationResponseMx' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return ObjectSerializer::deserialize($content, '\Walmart\Models\MP\CL\InternationalShipping\CommonResponseLabelGenerationResponseMx', $response->getHeaders());
            }

            $returnType = '\Walmart\Models\MP\CL\InternationalShipping\CommonResponseLabelGenerationResponseMx';
     ...
     * @throws \Walmart\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Walmart\Models\MP\CL\InternationalShipping\CommonResponseListCarrierPackageResponse
     */
    public function getCarrierPackageTypes(
        string $carrierShortName
    ): \Walmart\Models\MP\CL\InternationalShipping\CommonResponseListCarrierPackageResponse {
    ...
    protected function getCarrierPackageTypesWithHttpInfo(
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\Walmart\Models\MP\CL\InternationalShipping\CommonResponseListCarrierPackageResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Walmart\Models\MP\CL\InternationalShipping\CommonResponseListCarrierPackageResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return ObjectSerializer::deserialize($content, '\Walmart\Models\MP\CL\InternationalShipping\CommonResponseListCarrierPackageResponse', $response->getHeaders());
            }

            $returnType = '\Walmart\Models\MP\CL\InternationalShipping\CommonResponseListCarrierPackageResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     * @throws \Walmart\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Walmart\Models\MP\CL\InternationalShipping\CarrierCommonResponseListCarrierResponse
     */
    public function getCarriers(): \Walmart\Models\MP\CL\InternationalShipping\CarrierCommonResponseListCarrierResponse
    {
     ...
     * @return \Walmart\Models\MP\CL\InternationalShipping\CarrierCommonResponseListCarrierResponse
     */
    protected function getCarriersWithHttpInfo(): \Walmart\Models\MP\CL\InternationalShipping\CarrierCommonResponseListCarrierResponse
    {
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\Walmart\Models\MP\CL\InternationalShipping\CarrierCommonResponseListCarrierResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Walmart\Models\MP\CL\InternationalShipping\CarrierCommonResponseListCarrierResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return ObjectSerializer::deserialize($content, '\Walmart\Models\MP\CL\InternationalShipping\CarrierCommonResponseListCarrierResponse', $response->getHeaders());
            }

            $returnType = '\Walmart\Models\MP\CL\InternationalShipping\CarrierCommonResponseListCarrierResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Walmart\Models\MP\CL\InternationalShipping\CarrierCommonResponseListCarrierResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Walmart\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Walmart\Models\MP\CL\InternationalShipping\CommonResponseListLabelGenerationResponseMx
     */
    public function getLabel(
        string $purchaseOrderId
    ): \Walmart\Models\MP\CL\InternationalShipping\CommonResponseListLabelGenerationResponseMx {
    ...
    protected function getLabelWithHttpInfo(
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\Walmart\Models\MP\CL\InternationalShipping\CommonResponseListLabelGenerationResponseMx' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Walmart\Models\MP\CL\InternationalShipping\CommonResponseListLabelGenerationResponseMx' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return ObjectSerializer::deserialize($content, '\Walmart\Models\MP\CL\InternationalShipping\CommonResponseListLabelGenerationResponseMx', $response->getHeaders());
            }

            $returnType = '\Walmart\Models\MP\CL\InternationalShipping\CommonResponseListLabelGenerationResponseMx';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
