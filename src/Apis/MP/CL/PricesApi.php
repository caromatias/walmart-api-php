...
class PricesApi extends BaseApi
{
     ...
     * @return \Walmart\Models\MP\CL\Prices\FeedId
     */
    public function updateBulkPrices(
        string $feedType,
        \SplFileObject $file
    ): \Walmart\Models\MP\CL\Prices\FeedId {
    ...
    protected function updateBulkPricesWithHttpInfo(
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\Walmart\Models\MP\CL\Prices\FeedId' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Walmart\Models\MP\CL\Prices\FeedId' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return ObjectSerializer::deserialize($content, '\Walmart\Models\MP\CL\Prices\FeedId', $response->getHeaders());
            }

            $returnType = '\Walmart\Models\MP\CL\Prices\FeedId';
     ...
     * @throws \Walmart\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Walmart\Models\MP\CL\Prices\PartnerPriceResponse
     */
    public function updatePrice(
        string $body
    ): \Walmart\Models\MP\CL\Prices\PartnerPriceResponse {
    ...
    protected function updatePriceWithHttpInfo(
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\Walmart\Models\MP\CL\Prices\PartnerPriceResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Walmart\Models\MP\CL\Prices\PartnerPriceResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return ObjectSerializer::deserialize($content, '\Walmart\Models\MP\CL\Prices\PartnerPriceResponse', $response->getHeaders());
            }

            $returnType = '\Walmart\Models\MP\CL\Prices\PartnerPriceResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
