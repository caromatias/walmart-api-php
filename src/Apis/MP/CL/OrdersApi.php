...
class OrdersApi extends BaseApi
{
     ...
     * @param  \Walmart\Models\MP\CL\Orders\OrderAckRequest $orderAckRequest (required)
     *
     * @throws \Walmart\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return string|\Walmart\Models\MP\CL\Orders\ErrorResponse|\Walmart\Models\MP\CL\Orders\ErrorResponse
     */
    public function acknowledgeOrders(
        string $purchaseOrderId,
        \Walmart\Models\MP\CL\Orders\OrderAckRequest $orderAckRequest
    ): string {
     ...
     *
     * @param  string $purchaseOrderId purchaseOrderId (required)
     * @param  \Walmart\Models\MP\CL\Orders\OrderCancellationRequest $orderCancellationRequest File fields (required)
     *
     * @throws \Walmart\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return string|\Walmart\Models\MP\CL\Orders\ErrorResponse|\Walmart\Models\MP\CL\Orders\ErrorResponse
    ...
    public function cancelOrderLines(
        string $purchaseOrderId,
        \Walmart\Models\MP\CL\Orders\OrderCancellationRequest $orderCancellationRequest
    ): string {
     ...
     *
     * @param  string $purchaseOrderId purchaseOrderId (required)
     * @param  \Walmart\Models\MP\CL\Orders\Deliver $deliver File fields (required)
     *
     * @throws \Walmart\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return string|\Walmart\Models\MP\CL\Orders\ErrorResponse|\Walmart\Models\MP\CL\Orders\ErrorResponse
    ...
    public function deliveryUpdates(
        string $purchaseOrderId,
        \Walmart\Models\MP\CL\Orders\Deliver $deliver
    ): string {
     ...
     * @throws \Walmart\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Walmart\Models\MP\CL\Orders\CLOrderWithCursor|\Walmart\Models\MP\CL\Orders\ErrorResponse|\Walmart\Models\MP\CL\Orders\ErrorResponse
     */
    public function getAllOrdersUsingCursor(
        ...
        ?string $customerOrderId = null,
        ?string $purchaseOrderId = null
    ): \Walmart\Models\MP\CL\Orders\CLOrderWithCursor {
    ...
    protected function getAllOrdersUsingCursorWithHttpInfo(
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\Walmart\Models\MP\CL\Orders\CLOrderWithCursor' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Walmart\Models\MP\CL\Orders\CLOrderWithCursor' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return ObjectSerializer::deserialize($content, '\Walmart\Models\MP\CL\Orders\CLOrderWithCursor', $response->getHeaders());
                case 400:
                    if ('\Walmart\Models\MP\CL\Orders\ErrorResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
            ...
            $returnType = '\Walmart\Models\MP\CL\Orders\CLOrderWithCursor';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     * @throws \Walmart\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Walmart\Models\MP\CL\Orders\WFSOrderResponse
     */
     ...
     * Bulk Shipping Label
     *
     * @param  \Walmart\Models\MP\CL\Orders\ShippingLabelRequest $shippingLabelRequest Request body with list of tracking numbers (required)
     ...
     * @throws \Walmart\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return string|mixed|\Walmart\Models\MP\CL\Orders\ErrorResponse
     */
    public function postBulkShippingLabel(
        \Walmart\Models\MP\CL\Orders\ShippingLabelRequest $shippingLabelRequest,
        ?string $fORMAT = 'ZIP'
    ): string {
     ...
     *
     * @param  string $purchaseOrderId purchaseOrderId (required)
     * @param  \Walmart\Models\MP\CL\Orders\ShipmentMx $shipmentMx File fields (required)
     *
     * @throws \Walmart\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return string|\Walmart\Models\MP\CL\Orders\ErrorResponse|\Walmart\Models\MP\CL\Orders\ErrorResponse
    ...
    public function shippingUpdates(
        string $purchaseOrderId,
        \Walmart\Models\MP\CL\Orders\ShipmentMx $shipmentMx
    ): string {
