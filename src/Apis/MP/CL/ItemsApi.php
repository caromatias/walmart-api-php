...
class ItemsApi extends BaseApi
{
     ...
     * @return \Walmart\Models\MP\CL\Items\FeedId
     */
    public function bulkItemSetup(
        string $feedType,
        \SplFileObject $file
    ): \Walmart\Models\MP\CL\Items\FeedId {
    ...
    protected function bulkItemSetupWithHttpInfo(
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\Walmart\Models\MP\CL\Items\FeedId' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Walmart\Models\MP\CL\Items\FeedId' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return ObjectSerializer::deserialize($content, '\Walmart\Models\MP\CL\Items\FeedId', $response->getHeaders());
            }

            $returnType = '\Walmart\Models\MP\CL\Items\FeedId';
     ...
     * @throws \Walmart\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Walmart\Models\MP\CL\Items\ItemResponses
     */
    public function getAllItems(
        ...
        ?string $offset = '0',
        ?string $limit = '20'
    ): \Walmart\Models\MP\CL\Items\ItemResponses {
    ...
    protected function getAllItemsWithHttpInfo(
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\Walmart\Models\MP\CL\Items\ItemResponses' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Walmart\Models\MP\CL\Items\ItemResponses' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return ObjectSerializer::deserialize($content, '\Walmart\Models\MP\CL\Items\ItemResponses', $response->getHeaders());
            }

            $returnType = '\Walmart\Models\MP\CL\Items\ItemResponses';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
    ...
    public function getAnItem(
        string $sku
    ): \Walmart\Models\MP\CL\Items\ItemResponse {
    ...
    protected function getAnItemWithHttpInfo(
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\Walmart\Models\MP\CL\Items\ItemResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Walmart\Models\MP\CL\Items\ItemResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return ObjectSerializer::deserialize($content, '\Walmart\Models\MP\CL\Items\ItemResponse', $response->getHeaders());
            }

            $returnType = '\Walmart\Models\MP\CL\Items\ItemResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     * @throws \Walmart\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Walmart\Models\MP\CL\Items\ItemRetireResponseV2
     */
    public function retireAnItem(
        string $sKU
    ): \Walmart\Models\MP\CL\Items\ItemRetireResponseV2 {
    ...
    protected function retireAnItemWithHttpInfo(
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\Walmart\Models\MP\CL\Items\ItemRetireResponseV2' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Walmart\Models\MP\CL\Items\ItemRetireResponseV2' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return ObjectSerializer::deserialize($content, '\Walmart\Models\MP\CL\Items\ItemRetireResponseV2', $response->getHeaders());
            }

            $returnType = '\Walmart\Models\MP\CL\Items\ItemRetireResponseV2';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
